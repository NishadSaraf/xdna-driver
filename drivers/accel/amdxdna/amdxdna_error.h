 ...
 *
 * A probe that fails once slots have been armed unwinds through
 * amdxdna_async_events_abandon() rather than free(), because firmware only
 * gives an address back on a release it acknowledged.
 *
