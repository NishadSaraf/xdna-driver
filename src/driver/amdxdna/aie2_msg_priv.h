...
enum cmd_chain_npu_subcmd_type {
	CMD_CHAIN_NPU_SUBCMD_TYPE_NON_ELF	= 0x1,
	CMD_CHAIN_NPU_SUBCMD_TYPE_PARTIAL_ELF	= 0x2,
	CMD_CHAIN_NPU_SUBCMD_TYPE_PREEMPT	= 0x3,
	CMD_CHAIN_NPU_SUBCMD_TYPE_MAX
};

struct cmd_chain_slot_npu {
	union {
		enum cmd_chain_npu_subcmd_type type;
		u32 type_u32;
	};
	u64 inst_buf_addr;
	u64 save_buf_addr;
